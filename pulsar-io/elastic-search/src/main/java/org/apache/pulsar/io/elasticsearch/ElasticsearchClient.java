...
public class ElasticsearchClient {
    ...
    public boolean indexDocument(Record<Object> record, Pair<String, String> document) {
        try {
    ...
    public boolean deleteDocument(Record<Object> record, Pair<String, String> document) throws IOException {
        try {
